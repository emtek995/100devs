...
const reversePokemon = pokeArr => console.log(pokeArr.reverse());
...
const powSum = (arr, pow) => arr.reduce((a, c) => (c ** pow) + a, 0);
const compare = (a, b) => powSum(a, 2) > powSum(b, 3);
...
const mults = arr => arr.filter((e, i) => e % i == 0);
